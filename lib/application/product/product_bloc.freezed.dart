...
abstract class $ProductStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({HomeModel product, bool isLoading, bool isError, bool isSuccess});
}
...
class _$ProductStateImpl implements _ProductState {
  ...
  @override
  String toString() {
    return 'ProductState(product: $product, isLoading: $isLoading, isError: $isError, isSuccess: $isSuccess)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, product, isLoading, isError, isSuccess);
...
abstract class _ProductState implements ProductState {
  const factory _ProductState(
      ...
      required final bool isSuccess}) = _$ProductStateImpl;
